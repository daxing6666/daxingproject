package com.briup.frame.net.config;

import android.os.Environment;
import android.text.TextUtils;
import com.briup.frame.net.cookie.CookieJarImpl;
import com.briup.frame.net.cookie.store.CookieStore;
import com.briup.frame.net.http.HttpClient;
import com.briup.frame.net.http.SSLUtils;
import com.briup.frame.net.interceptor.HeaderInterceptor;
import com.briup.frame.net.interceptor.NetCacheInterceptor;
import com.briup.frame.net.interceptor.NoNetCacheInterceptor;
...
public class OkHttpConfig {
    ...
    private static final String defaultCachePath = Environment.getExternalStorageDirectory().getPath() +
            "/rxHttpCacheData";
    ...
    public static class Builder {
        ...
        private long readTimeout;//数据读取超时时间
